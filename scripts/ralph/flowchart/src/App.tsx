...
const shortTitle: Record<string, string[]> = {
  ...
  S191: ['S191 P31', 'Library Actions',    'Doc context menu'],
  S192: ['S192 P32', 'Reader Notes',       'Auto-collection sidebar'],
  S193: ['S193 P33', 'Glossary Persist',   'DB storage + categories'],
  S194: ['S194 P34', 'Ref Validation',     'URL HEAD checks'],
...
const storyEdges: Edge[] = [
  ...
  // Phase 5 internal
  { id: 'e-192-197', source: 'S192', target: 'S197', label: 'auto-collection', labelStyle: { fontSize: 10 }, ...depEdge },
  // Phase 4 -> Phase 5
  { id: 'e-187-195', source: 'S187', target: 'S195', label: 'templates fallback', labelStyle: { fontSize: 10 }, ...ph2Edge },
