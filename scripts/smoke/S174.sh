...
MD_RESP=$(curl -sf -w "\n%{http_code}\n%{content_type}" -o $SMOKE_TMP/s174_vault.zip \
...
python3 -c "
import zipfile
zf = zipfile.ZipFile('$SMOKE_TMP/s174_deck.apkg')
