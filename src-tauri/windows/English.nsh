; Tauri 2.11.4's English.nsh with deleteAppData relabelled: its "Delete the application
; data" deletes the whole library. Re-copy it from Tauri's source when upgrading the Tauri CLI.
...
LangString deleteAppData ${LANG_ENGLISH} "Also delete my library (documents, notes, cards, models)"
