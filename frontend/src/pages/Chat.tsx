...
export default function Chat() {
  ...
  // Pre-fill input from chatPreload set by SelectionActionBar; autoSubmit triggers send.
  useEffect(() => {
    if (chatPreload) {
      ...
      await streamQa(
        ...
        },
        {
          ...
          onDone: (done) => {
            ...
            setIsStreaming(false)
            // refresh suggestion pills after each answered question
  ...
  // navigate to Learning tab with DocumentReader open at the cited section/page.
