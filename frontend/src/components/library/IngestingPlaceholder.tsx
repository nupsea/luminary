        ...
        <div className="flex flex-wrap items-center justify-end gap-2 pt-1">
          ...
          {confirmingDelete ? (
            ...
            <button
              ...
              className="flex items-center gap-1 rounded-md border border-red-200 bg-red-50 px-3 py-1.5 text-sm font-medium text-red-700 transition-colors hover:bg-red-100 dark:border-red-900 dark:bg-red-950/40 dark:text-red-300 dark:hover:bg-red-900/50"
            >
              <Trash2 size={14} />
