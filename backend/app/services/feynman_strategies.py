"""Feynman service implementation details: prompt templates, parsers, and background task helper.

Separated from feynman_service.py so the FeynmanService class stays focused on
session orchestration. These are the swappable bits -- parsers and prompts can be
...
# rubric evaluation prompts (duplicated in study.py -- same layer)
_RUBRIC_SYSTEM = (
...
# model explanation prompt templates
