...
| v3 Phase 7 | `scripts/ralph/prd-v3.json` | `feat/attention_streak` | S208-S211 -- Focused Learning (Pomodoro + goals) |
...
## V3 Phase 7 Story Status

| Story | Title | Status |
|---|---|---|
| S208 | Pomodoro session backend: model, service, and API | pass |
